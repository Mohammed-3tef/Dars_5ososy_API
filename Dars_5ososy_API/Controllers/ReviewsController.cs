...
namespace Dars_5ososy_API.Controllers
{
    ...
    public class ReviewsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllReviews()
        {
            ...
            return Ok(ApiResponse<object>.Succeeded(Reviews, "Reviews retrieved successfully."));
        }
        ...
        public async Task<IActionResult> GetReviewByStudentAndTeacher(string studentUsername, string teacherUsername)
        {
            ...
            return Ok(ApiResponse<object>.Succeeded(review, "Review retrieved successfully."));
        }
        ...
        public async Task<IActionResult> CreateReview(ReviewDTO ReviewDto)
        {
            ...
            return CreatedAtAction(nameof(GetAllReviews), ApiResponse<object>.Succeeded(createdReview, "Review created successfully."));
        }
        ...
        public async Task<IActionResult> UpdateReview(ReviewDTO ReviewDto)
        {
            ...
            return Ok(ApiResponse<object>.Succeeded(updatedReview, "Review updated successfully."));
        }
