...
namespace Dars_5ososy_API.Controllers
{
    ...
    public class ProvincesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllProvinces()
        {
            ...
            return Ok(ApiResponse<List<ProvinceDTO>>.Succeeded(Provinces, "Provinces retrieved successfully."));
        }
        ...
        public async Task<IActionResult> GetProvinceByArabicName(string ProvinceArabicName)
        {
            ...
            return Ok(ApiResponse<ProvinceDTO>.Succeeded(Province, "Province retrieved successfully."));
        }
        ...
        /// <response code="400">Province with the same name already exists.</response>
        [HttpPost("create")]
        ...
        public async Task<IActionResult> CreateProvince(ProvinceDTO ProvinceDto)
        {
            ...
            return CreatedAtAction(nameof(GetProvinceByArabicName), new { ProvinceArabicName = createdProvince.ArabicName }, ApiResponse<ProvinceDTO>.Succeeded(createdProvince, "Province created successfully."));
        }
        ...
        public async Task<IActionResult> UpdateProvince(ProvinceDTO ProvinceDto)
        {
            ...
            return Ok(ApiResponse<ProvinceDTO>.Succeeded(updatedProvince, "Province updated successfully."));
        }
